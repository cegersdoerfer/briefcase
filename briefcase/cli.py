...
from briefcase.gitops import clone_repo, pull_repo
from briefcase.registry import add_tool, ensure_dirs, get_paths, get_tool, list_tools
...
@app.command()
def add(name: str, repo_url: str) -> None:
    ...
    try:
        ...
        add_tool(name, repo_url, home=_home)
        console.print(f"[green]Added '{name}' from {repo_url}[/green]")
...
def new(
    ...
    try:
        project_dir = create_project(project_name, tool, home=_home)
